...
//includes bees that oscillate around a flower
...
Flower.prototype.display = function(){
    ...
    //leaf
    fill (96, 189, 104);
    ellipse(211,287,21,17);
     ellipse(189,261,21,17);
};
...
//creating a function that is an instance of a particle
var Winston = function(position){
    Particle.call(this, position);
};

//creating object with same prototypes as particle
...
//defining the properties of the bee
var Bug = function() {
    this.a = 0;
    this.angVelocity = 0;
